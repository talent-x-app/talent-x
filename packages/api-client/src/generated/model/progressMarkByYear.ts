...
/**
 * Meilleure marque d'une année civile pour une épreuve (ADR-34).
 */
export interface ProgressMarkByYear {
  /** Année civile. */
  year: number;
  /** Meilleure marque de l'année (sens de l'épreuve). */
  best: number;
  /** Nombre de marques enregistrées cette année-là. */
  count: number;
}
