 ...
 * Discipline (vertical).
 */
export type ManualRecordRequestDiscipline = typeof ManualRecordRequestDiscipline[keyof typeof ManualRecordRequestDiscipline];


export const ManualRecordRequestDiscipline = {
  high: 'high',
  pole: 'pole',
} as const;
