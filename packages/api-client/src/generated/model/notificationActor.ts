...
/**
 * Acteur d'une notification (ADR-55) — prénom minimisé, résolu au read pour le feed in-app uniquement (jamais dans le push).
 */
export interface NotificationActor {
  id: string;
  /** Prénom (minimisé) de l'acteur — « Prénom N. » en cas d'homonymie. */
  displayName: string;
}
