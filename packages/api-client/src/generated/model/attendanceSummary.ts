...
/**
 * Agrégat de présence d'une séance (ADR-45) — compteurs SANS identités (RGPD, ADR-43 §5). Calculé sur toutes les affectations actives partageant le sessionId.
 */
export interface AttendanceSummary {
  going: number;
  notGoing: number;
  maybe: number;
  /** Affectations sans présence déclarée (attendance NULL). */
  noResponse: number;
  total: number;
}
