...
## À faire
- **TLX-005** Design system en code : tokens RN + CSS + thème typé — Réf : design/tokens.json
- **TLX-011** Squelette NestJS + DTO/contrôleurs depuis l'OpenAPI — Réf : docs/talent-x-openapi.yaml
