...
| ADR-49 | Mur Palier 2 : exécution réactions nominatives + kudos de participation (exécute ADR-48 P2 · réutilise ADR-37/43/22/23 · TX-DPIA-007 §5.6 · TLX-185) | Accepté |
...
| ADR-52 | Grammaire unifiée « série » pour la création de séance : suppression du mot « bloc », champ « Séries » → « Tours », et série **libre** rendue par une **carte d'effort générique** (catalogue Type d'effort) au lieu de l'éditeur brut — révise ADR-42 §1/§3 (complète ADR-38/39/41) | Accepté |
